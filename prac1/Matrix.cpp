...
template<int n, int m>
template<int a>
Matrix<n, a> Matrix<n, m>::operator*(const Matrix<m, a> &other) const { return Matrix<n, a>(); }

template<int n, int m>
Matrix<n, m> Matrix<n, m>::operator*(const float scalar) const { return Matrix<n, m>(); }
